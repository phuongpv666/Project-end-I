...
// function to handle login form closing
function closeLoginForm() {
  // disable login if user is logged in
  if (isLoggedIn) {
    alert('Please log out before closing the form');
  } else {
...
loginForm.addEventListener('submit', function(e) {
  ...
  if (email === 'example@example.com' && password === 'password') {
    ...
    // save user info to local storage if "remember me" is checked
...
// check if "remember me" is checked and load saved user info
if (rememberCheckbox.checked) {
